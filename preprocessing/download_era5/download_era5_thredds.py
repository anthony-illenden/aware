...
def calc_vars(ds, level, output_dir):
    ...
    for time in time_list:
        try:
            ...
            vort_lev = mpcalc.vorticity(u_lev, v_lev) * 1e5  # units: 1/s
            ...
            # --- FIX: convert time to pandas Timestamp for filenames and expand_dims ---
            ...
            save_ds(ds_final, output_dir, time_str)
...
if __name__ == '__main__':
    ...
    end_date = "2015-09-30" # YYYY-MM-DD
    level = 925 # units: hPa
